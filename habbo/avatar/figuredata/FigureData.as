package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureData implements class_259
   {
      
      public static const MALE:String = "M";
      
      public static const const_118:String = "F";
      
      public static const const_103:String = "U";
      ...
      private var var_18:FigureDataView;
      
      private var var_24:Dictionary;
      ...
      private var var_81:int = 4;
      
      private var var_3657:int = -1;
      ...
      public function FigureData(param1:HabboAvatarEditor)
      {
         ...
         var_18 = new FigureDataView(this);
      }
      ...
      public function getFigureString() : String
      {
         ...
         var _loc6_:String = "";
         var _loc1_:Array = [];
         for(var _loc7_ in var_24)
         {
            if(var_24[_loc7_] != null)
            {
               _loc2_ = var_24[_loc7_];
      ...
      {
         var_18.update(getFigureString(),var_3657,var_81);
      }
