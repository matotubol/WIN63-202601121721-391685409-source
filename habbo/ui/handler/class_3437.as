package com.sulake.habbo.ui.handler
{
   ...
   public class class_3437 implements IRoomWidgetHandler
   {
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         if(!var_2454)
         {
            var_2454 = new class_2781(onStartConfirmation);
            var_3609 = new class_3502(onOtherLockConfirmed);
            var_3570 = new class_2890(onCancelLock);
      ...
      {
         var_37.send(new class_2688(param1,param2));
      }
      
      private function onStartConfirmation(param1:class_2781) : void
      {
         var_16.open(param1.getParser().stuffId,param1.getParser().isOwner);
      }
      
      private function onOtherLockConfirmed(param1:class_3502) : void
      {
         var_16.otherConfirmed(param1.getParser().stuffId);
      }
      
      private function onCancelLock(param1:class_2890) : void
      {
