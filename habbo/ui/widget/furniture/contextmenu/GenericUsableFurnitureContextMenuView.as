package com.sulake.habbo.ui.widget.furniture.contextmenu
{
   ...
   public class GenericUsableFurnitureContextMenuView extends FurnitureContextInfoView
   {
      ...
      public function GenericUsableFurnitureContextMenuView(param1:class_1853)
      {
         super(param1);
      }
      ...
      override protected function updateWindow() : void
      {
         ...
         else
         {
            if(!_window)
            {
               _loc1_ = XmlAsset(var_16.assets.getAssetByName("generic_usable_menu")).content as XML;
