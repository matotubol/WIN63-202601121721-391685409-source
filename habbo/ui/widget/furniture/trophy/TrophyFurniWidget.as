package com.sulake.habbo.ui.widget.furniture.trophy
{
   ...
   public class TrophyFurniWidget extends RoomWidgetBase implements ITrophyFurniWidget
   {
      ...
      public function TrophyFurniWidget(param1:IRoomWidgetHandler, param2:class_38, param3:class_40, param4:class_27, param5:class_16)
      {
      ...
      private function updateInterface() : void
      {
         ...
         switch(var_3530 - 10)
         {
            case 0:
            case 10:
               var_18 = new NikoTrophyView(this,var_3530);
               break;
            default:
