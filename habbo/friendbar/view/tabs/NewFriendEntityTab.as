package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class NewFriendEntityTab extends Tab
   {
      ...
      private static const const_626:String = "new_friend_entity_xml";
      ...
      private static const const_17:Vector.<NewFriendEntityTab> = new Vector.<NewFriendEntityTab>();
      ...
      public static function allocate(param1:class_3462) : NewFriendEntityTab
      {
         var _loc2_:NewFriendEntityTab = const_17.length > 0 ? const_17.pop() : new NewFriendEntityTab();
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            ...
            if(friend.online)
            {
               _loc6_ = WINDOWING.buildFromXML(ASSETS.getAssetByName("new_controls_piece_xml").content as XML) as class_1812;
      ...
      {
         var _loc1_:class_1812 = const_16.length > 0 ? const_16.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName("new_friend_entity_xml").content as XML) as class_1812;
      ...
      public function addNotificationToken(param1:class_2307) : void
      {
         ...
         {
            case 1:
               var _loc7_:Token = new RoomEventToken(friend,param1);
               _loc7_.iconElement.addEventListener("WME_CLICK",onMouseClick);
               var _loc3_:String = "icon_tag_notify";
               break;
            case 2:
            ...
            case 4:
               ...
               null.iconElement.addEventListener("WME_CLICK",onMouseClick);
               _loc3_ = "icon_tag_game";
               _isInGame = true;
               var_1787 = null.notification.message;
               break;
            case 0:
               break;
            case 5:
