package com.sulake.habbo.room.object.visualization.avatar.additions
{
   ...
   public class TypingBubble implements class_2504
   {
      ...
      public function update(param1:IRoomObjectSprite, param2:Number) : void
      {
         ...
         if(param2 < 48)
         {
            _asset = var_213.getAvatarRendererAsset("user_typing_small_png") as BitmapDataAsset;
            var _loc3_:int = 3;
            var _loc4_:int = -42;
            var _loc5_:int = 32;
         }
         ...
         {
            _asset = var_213.getAvatarRendererAsset("user_typing_png") as BitmapDataAsset;
            _loc3_ = 14;
            _loc4_ = -83;
         }
