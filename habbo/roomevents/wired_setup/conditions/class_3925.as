package com.sulake.habbo.roomevents.wired_setup.conditions
{
   ...
   public class class_3925 extends DefaultConditionType
   {
      ...
      {
         return class_4100.TIME_ELAPSED_MORE;
      }
      
      override public function readIntParamsFromForm() : Array
      {
         var _loc1_:Array = [];
         var _loc2_:int = var_1174.getValue();
      ...
      override public function onInit(param1:class_1812, param2:class_1812, param3:HabboUserDefinedRoomEvents) : void
      {
         ...
         _roomEvents = param3;
         var_1174 = new SliderWindowController(param3,getInput(param1),param3.assets,1,1200,1);
         var_1174.setValue(1);
