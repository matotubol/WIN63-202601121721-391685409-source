package com.sulake.habbo.phonenumber
{
   ...
   public class PhoneNumberCollectMinimizedView
   {
      ...
      private function createWindow() : void
      {
         ...
         _window = var_59.windowManager.buildFromXML(XML(var_59.assets.getAssetByName("phonenumber_collect_minimized_xml").content));
      ...
      {
         var_59.setCollectViewMinimized(false);
      }
